...
CREATE TABLE IF NOT EXISTS intents (
    ...
    scanner_side        TEXT,
    scanner_confidence_quantile REAL DEFAULT 0,
    scanner_regime_rank_pct REAL DEFAULT 0,
    scanner_risk_rank_pct   REAL DEFAULT 0,
    scanner_spread_cost_bps REAL DEFAULT 0,
    scanner_net_forward_return REAL DEFAULT 0,
...
INSERT INTO intents (
    ...
    scanner_confidence_quantile, scanner_regime_rank_pct,
    scanner_risk_rank_pct, scanner_spread_cost_bps, scanner_net_forward_return,
...
class DecisionStore:
    ...
    def _ensure_columns(self) -> None:
        ...
        migrations = [
            ...
            ("intents", "scanner_version", "TEXT DEFAULT ''"),
            ...
            ("intents", "scanner_confidence_quantile", "REAL DEFAULT 0"),
            ("intents", "scanner_regime_rank_pct", "REAL DEFAULT 0"),
            ("intents", "scanner_risk_rank_pct", "REAL DEFAULT 0"),
            ("intents", "scanner_spread_cost_bps", "REAL DEFAULT 0"),
            ("intents", "scanner_net_forward_return", "REAL DEFAULT 0"),
    ...
    def insert_intent(self, intent: TradeIntent) -> None:
        ...
        params = {
            ...
            "scanner_version": intent.scanner_version,
            ...
            "scanner_confidence_quantile": intent.scanner_confidence_quantile,
            "scanner_regime_rank_pct": intent.scanner_regime_rank_pct,
            "scanner_risk_rank_pct": intent.scanner_risk_rank_pct,
            "scanner_spread_cost_bps": intent.scanner_spread_cost_bps,
            "scanner_net_forward_return": intent.scanner_net_forward_return,
