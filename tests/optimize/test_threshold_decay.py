...
def test_decay_after_1_day_inactive() -> None:
    ...
    assert result["EURUSD"].min_blended_confidence == 0.54
...
def test_decay_after_2_days_inactive() -> None:
    ...
    assert result["EURUSD"].min_blended_confidence == 0.53
...
def test_full_decay_after_3_days_inactive() -> None:
    ...
    assert result["EURUSD"].min_blended_confidence == 0.52
...
def test_positive_adjustment_not_decayed() -> None:
    ...
    assert result["EURUSD"].min_blended_confidence == 0.49
...
def test_mixed_symbols_with_different_inactivity() -> None:
    ...
    assert result["EURUSD"].min_blended_confidence == 0.54
    assert result["GBPUSD"].min_blended_confidence == 0.52
    assert result["USDJPY"].min_blended_confidence == 0.49
